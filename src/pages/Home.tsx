...
export default function Home() {
    ...
    const expeditions = Object.values(expeditionsData);

    const scrollToCard = (index: number) => {
        const slider = sliderRef.current;
        if (!slider) return;

        const cards = slider.querySelectorAll('.trip-card');
        if (index < 0) index = 0;
    ...
    const handleSliderScroll = () => {
        ...
        progress.style.width = `${(clientWidth / scrollWidth) * 100}%`;
        progress.style.left = `${(scrollLeft / scrollWidth) * 100}%`;

        const scrollRatio = scrollLeft / (scrollWidth - clientWidth || 1);
        const index = Math.round(scrollRatio * (expeditions.length - 1));
        setActiveDot(index);
    };
    ...
    useEffect(() => {
        ...
        if (slider) {
            ...
            // Run initially to calculate size
            setTimeout(handleSliderScroll, 100);
        }

        // Add resize listener to keep progress bar correct
        const handleResize = () => {
            handleSliderScroll();
        };
                    ...
                    <div className="hero__content">
                        ...
                        <div className="hero__stats">
                            <div className="hero__stat">
                                <h3>8,611m</h3>
                                <p>K2 Peak Altitude</p>
                            </div>
                            <div className="hero__stat-divider"></div>
                            <div className="hero__stat">
                                <h3>5,585m</h3>
                                <p>Highest Trek Pass</p>
                            </div>
                            <div className="hero__stat-divider"></div>
                            <div className="hero__stat">
                                <h3>20+</h3>
                                <p>Guided Expeditions</p>
                            </div>
                            <div className="hero__stat-divider"></div>
                            <div className="hero__stat">
                                <h3>99.4%</h3>
            ...
            <section className="featured-trips" id="featured-trips">
                ...
                <div className="container">
                    ...
                    <div className="featured-trips__slider-wrapper">
                        ...
                        <div className="featured-trips__slider" ref={sliderRef}>
                    ...
                    <div className="featured-trips__progress-container">
                        <div className="featured-trips__progress-bar" ref={progressBarRef}></div>
                    </div>
                    ...
                    <div className="featured-trips__pagination">
                        {expeditions.map((_, index) => (
                            <span
                                key={index}
                                className={`featured-trips__pagination-item ${activeDot === index ? 'featured-trips__pagination-item--active' : ''}`}
            ...
            <section className="who-we-are" id="who-we-are">
                <div className="container who-we-are__container">
                    ...
                    <div className="who-we-are__images">
                        ...
                        <img src="/assets/images/who-we-are-main.webp" alt="Hunza Valley Morning" className="who-we-are__img-main" referrerPolicy="no-referrer" />
                        <img src="/assets/images/who-we-are-small.webp" alt="Mountain Tea" className="who-we-are__img-small" referrerPolicy="no-referrer" />
                    </div>
            ...
            <section className="travel-insights" id="travel-insights">
                <div className="container">
                    ...
                    <div className="travel-insights__grid">
                        ...
                        <a href="/blog-post?id=k2-guide" className="insight-card insight-card--large">
                        ...
                        <div className="travel-insights__stack">
                            ...
                            <a href="/blog-post?id=snow-lake-guide" className="insight-card insight-card--small">
